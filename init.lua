...
local telescopemaps = {
	...
	keymaps = {
		...
		{ '<leader>dot', function() require("plugins.telescop_setvp").search_dotfiles() end, description = 'dotfiles' , opts = telescopts},
		{ '<leader>cfg', function() require("plugins.telescop_setvp").search_config() end, description = 'config' , opts = telescopts},
		{ '<leader>cd', function() require("plugins.telescop_setvp").file_browser() end, description = 'file browser', opts = telescopts},
		{ '<leader>ang', function() require("plugins.telescop_setvp").angular() end, description = 'telescope angular' , opts = telescopts},
		{ '<leader>gb', function() require("plugins.telescop_setvp").git_branches() end, description = 'git banches', opts = telescopts},
		{ '<leader>ggs', function() require("plugins.telescop_setvp").git_status() end, description = 'git git statuses', opts = telescopts},
		{ '<C-f>', function() require("telescope.builtin").find_files() end, description = 'find files', opts = telescopts},
		{ '<C-g>', function() require("plugins.telescop_setvp").git_files() end, description = 'git files', opts = telescopts},
